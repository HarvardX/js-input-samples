...
- `hxSetData('whatever', stuff)` will store the `stuff` object in the `whatever` variable. You can also call `hxSetData({a_whole_entire_object})` and the backpack will get updated with the object.
